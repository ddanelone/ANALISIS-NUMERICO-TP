...
import { handleInciso2 } from "@/lib/handlersTP2/inciso2";
import { handleInciso3 } from "@/lib/handlersTP2/inciso3";
import { handleInciso1 } from "@/lib/handlersTP2/inciso1";

const TrabajoPractico2 = () => {
  ...
  const isAnyLoading = isLoading || isLoading1 || isLoading2;
  ...
  `}
      >
        ...
        <ul className="space-y-4 mt-6 w-full">
          <li className="text-lg font-bold px-1 text-center">T.P. 2</li>
          <li>
            <IncisoButton
              label="Inciso 1"
...
export default TrabajoPractico2;
